package com.gz.framework.interceptor.impl;

import com.alibaba.fastjson2.JSON;
import com.gz.common.annotation.RepeatSubmit;
...
import com.gz.framework.interceptor.RepeatSubmitInterceptor;
import com.gz.framework.security.filter.repeatable.RepeatedlyRequestWrapper;
...
public class SameUrlDataInterceptor extends RepeatSubmitInterceptor {
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation) {
        ...
        // 唯一值（没有消息头则使用请求地址）
        String submitKey = StringUtil.trimToEmpty(request.getHeader(header));
