package com.gz.framework.util.file;

import com.gz.common.constant.Constant;
import com.gz.framework.exception.file.FileNameLengthLimitExceededException;
import com.gz.framework.exception.file.FileSizeLimitExceededException;
import com.gz.framework.exception.file.InvalidExtensionException;
import com.gz.common.util.DateUtil;
import com.gz.common.util.StringUtil;
import com.gz.common.util.uuid.Seq;
...
public class FileUploadUtil {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = GzConfig.getProfile();
    ...
    public static final String extractFilename(MultipartFile file) {
        return StringUtil.format("{}/{}_{}.{}", DateUtil.datePath(),
    ...
    public static final String getPathFileName(String uploadDir, String fileName) throws IOException {
        int dirLastIndex = GzConfig.getProfile().length() + 1;
