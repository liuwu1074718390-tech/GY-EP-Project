...
public class SysPostController extends BaseController {
    ...
    @Log(title = "岗位管理", businessType = BizTypeEnum.EXPORT)
    ...
    @Log(title = "岗位管理", businessType = BizTypeEnum.INSERT)
    @PostMapping
    ...
    @Log(title = "岗位管理", businessType = BizTypeEnum.UPDATE)
    @PutMapping
    ...
    @Log(title = "岗位管理", businessType = BizTypeEnum.DELETE)
