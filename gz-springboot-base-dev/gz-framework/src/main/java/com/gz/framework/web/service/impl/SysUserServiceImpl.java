...
import com.gz.common.annotation.DataScope;
...
import com.gz.framework.util.bean.BeanValidator;
import com.gz.framework.util.SpringUtil;
import com.gz.framework.web.domain.entity.SysPost;
import com.gz.framework.web.domain.entity.SysUserPost;
import com.gz.framework.web.domain.entity.SysUserRole;
import com.gz.framework.web.mapper.*;
...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public boolean checkUserNameUnique(SysUser user) {
        ...
        if (StrUtil.equals(user.getUserName(), Constant.VISITOR_NAME)) {
            return UserConstant.NOT_UNIQUE;
        }
    ...
    public void insertUserPost(SysUser user) {
        ...
        if (StringUtil.isNotEmpty(posts)) {
            // 新增用户与岗位管理
        ...
        for (SysUser user : userList) {
            try {
                ...
                if (StringUtil.isNull(u)) {
                    BeanValidator.validateWithException(validator, user);
