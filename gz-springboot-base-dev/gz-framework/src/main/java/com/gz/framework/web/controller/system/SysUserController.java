...
import com.gz.framework.web.service.ISysPostService;
...
public class SysUserController extends BaseController {
    ...
    @Log(title = "用户管理", businessType = BizTypeEnum.EXPORT)
    ...
    @Log(title = "用户管理", businessType = BizTypeEnum.IMPORT)
    ...
    @Log(title = "用户管理", businessType = BizTypeEnum.INSERT)
    @PostMapping
    ...
    @Log(title = "用户管理", businessType = BizTypeEnum.UPDATE)
    @PutMapping
    ...
    @Log(title = "用户管理", businessType = BizTypeEnum.DELETE)
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:user:edit')")
    @Log(title = "用户管理", businessType = BizTypeEnum.GRANT)
    @PutMapping("/authRole")
