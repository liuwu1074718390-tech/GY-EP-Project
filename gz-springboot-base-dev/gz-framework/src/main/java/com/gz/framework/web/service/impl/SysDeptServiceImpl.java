...
import com.gz.framework.web.mapper.SysDeptMapper;
...
public class SysDeptServiceImpl implements ISysDeptService {
     ...
     */
    @Override
    public List<TreeSelectVO> selectDeptTreeList(SysDept dept) {
    ...
    public int updateDept(SysDept dept) {
        ...
        if (UserConstant.DEPT_NORMAL.equals(dept.getStatus()) && StringUtil.isNotEmpty(dept.getAncestors())
