...
import com.gz.common.util.sign.Base64Util;
...
public class CaptchaController {
    ...
    public AjaxResult getCode(HttpServletResponse response) throws IOException {
        ...
        // 生成验证码
        String captchaType = GzConfig.getCaptchaType();
        ...
        redisUtil.setCacheObject(verifyKey, code, Constant.CAPTCHA_EXPIRATION, TimeUnit.MINUTES);
        // 转换流信息写出
        ...
        ajax.put("uuid", uuid);
        ajax.put("img", Base64Util.encode(os.toByteArray()));
        return ajax;
    }
}
