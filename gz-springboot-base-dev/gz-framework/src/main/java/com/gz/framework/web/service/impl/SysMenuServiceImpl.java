...
import com.gz.framework.web.domain.vo.TreeSelectVO;
...
import com.gz.framework.web.domain.vo.MetaVo;
import com.gz.framework.web.domain.vo.RouterVo;
import com.gz.framework.web.mapper.SysMenuMapper;
import com.gz.framework.web.mapper.SysRoleMapper;
import com.gz.framework.web.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            ...
            if (StringUtil.isNotEmpty(cMenus) && UserConstant.TYPE_DIR.equals(menu.getMenuType())) {
    ...
    public boolean isInnerLink(SysMenu menu) {
        return menu.getIsFrame().equals(UserConstant.NO_FRAME) && StringUtil.ishttp(menu.getPath());
    }
    ...
    public String innerLinkReplaceEach(String path) {
        return StringUtil.replaceEach(path, new String[]{Constant.HTTP, Constant.HTTPS, Constant.WWW, ".", ":"},
                new String[]{"", "", "", "/", "/"});
    }
}
