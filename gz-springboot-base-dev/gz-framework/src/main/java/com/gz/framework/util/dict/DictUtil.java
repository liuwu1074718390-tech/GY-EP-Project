...
public class DictUtil {
    ...
    public static void setDictCache(String key, List<SysDictData> dictDatas) {
        SpringUtil.getBean(RedisUtil.class).setCacheObject(getCacheKey(key), dictDatas);
    }
    ...
    public static List<SysDictData> getDictCache(String key) {
        JSONArray arrayCache = SpringUtil.getBean(RedisUtil.class).getCacheObject(getCacheKey(key));
    ...
    public static String getDictLabel(String dictType, String dictValue, String separator) {
        ...
        if (StringUtil.isNotNull(datas) && StringUtil.isNotBlank(dictValue)) {
    ...
    public static void removeDictCache(String key) {
        SpringUtil.getBean(RedisUtil.class).deleteObject(getCacheKey(key));
    }
    ...
    public static void clearDictCache() {
        Collection<String> keys = SpringUtil.getBean(RedisUtil.class).keys(CacheConstant.SYS_DICT_KEY + "*");
