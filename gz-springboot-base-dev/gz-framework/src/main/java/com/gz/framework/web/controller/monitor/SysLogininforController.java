...
import com.gz.framework.web.api.SysPasswordService;
...
public class SysLogininforController extends BaseController {
    ...
    @Log(title = "登录日志", businessType = BizTypeEnum.EXPORT)
    ...
    @Log(title = "登录日志", businessType = BizTypeEnum.DELETE)
    ...
    @PreAuthorize("@ss.hasPermi('monitor:logininfor:remove')")
    @Log(title = "登录日志", businessType = BizTypeEnum.CLEAN)
    @DeleteMapping("/clean")
    ...
    @Log(title = "账户解锁", businessType = BizTypeEnum.OTHER)
